...
mysqli_query($con,"DELETE FROM subject WHERE subid ='$_GET[slid]'");
}
...
$result = mysqli_query($con,"SELECT * FROM subject LIMIT $_GET[first] , $_GET[last]");
$result1 = mysqli_query($con,"SELECT * FROM course LIMIT $_GET[first] , $_GET[last]");
$reslec = mysqli_query($con,"SELECT * FROM lectures LIMIT $_GET[first] , $_GET[last]");
?>
