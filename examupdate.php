...
{
mysqli_query($con,"UPDATE examination SET scored='$_POST[scored]', 	result='$_POST[result]' WHERE examid ='$_POST[examid]'");

}

$result = mysqli_query($con,"SELECT * FROM examination where examid ='$_GET[exid]'");	
